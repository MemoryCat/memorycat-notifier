...
public class ServerMessageHandler implements IoHandler {
	...
	private final MPushMessageServerEventDisptcher mPushMessageEventDisptcher;

	public ServerMessageHandler(MPushMessageServer mPushMessageServer) {
		super();
		this.mPushMessageServer = mPushMessageServer;
		this.mPushMessageEventDisptcher = new MPushMessageServerEventDisptcher(this.mPushMessageServer);
	}
