...
class MPushMessageServerProtocolDecoder implements ProtocolDecoder {
	...
	private static final Logger logger = LoggerFactory.getLogger(MPushMessageServerProtocolDecoder.class);

	private final ServerConfiguration serverConfiguration;

	public MPushMessageServerProtocolDecoder(ServerConfiguration serverConfiguration) {
		super();
