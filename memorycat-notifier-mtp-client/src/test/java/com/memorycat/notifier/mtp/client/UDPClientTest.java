...
import com.memorycat.notifier.mtp.client.impl.DefaultUdpConnectionConfig;
...
public class UDPClientTest {
	public static void main(String[] args) throws MtpEntityException, IOException, Exception {
		...
		DefaultClientContext defaultClientContext = ClientContextBuilder.buildDefaultClientContext();
		defaultClientContext.setConnectionConfig(new DefaultUdpConnectionConfig("127.0.0.1", 8000));
		defaultClientContext.getUser()
				.setAuthenticator(new AccountPasswordAuthenticator(new AccountPasswordEntity("a", "a")));
